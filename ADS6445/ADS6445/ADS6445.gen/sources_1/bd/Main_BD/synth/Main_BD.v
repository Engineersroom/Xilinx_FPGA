...
module Main_BD
   (USER_SMA,
    ...
    rs232_uart_rxd,
    rs232_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.USER_SMA CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.USER_SMA, CLK_DOMAIN Main_BD_clk_wiz_1_0_clk_out1, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output USER_SMA;
