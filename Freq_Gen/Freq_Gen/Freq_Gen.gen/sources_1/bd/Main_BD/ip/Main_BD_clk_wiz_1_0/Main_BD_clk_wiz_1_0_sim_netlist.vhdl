...
--               d:/Personal/FPGA/XilinxFPGA/Freq_Gen/Freq_Gen/Freq_Gen.gen/sources_1/bd/Main_BD/ip/Main_BD_clk_wiz_1_0/Main_BD_clk_wiz_1_0_sim_netlist.vhdl
...
architecture STRUCTURE of Main_BD_clk_wiz_1_0_clk_wiz is
  ...
  signal clk_out2_Main_BD_clk_wiz_1_0 : STD_LOGIC;
...
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_Main_BD_clk_wiz_1_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT1 => clk_out2_Main_BD_clk_wiz_1_0,
