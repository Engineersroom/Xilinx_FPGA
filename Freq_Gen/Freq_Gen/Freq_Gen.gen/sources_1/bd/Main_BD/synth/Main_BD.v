...
(* CORE_GENERATION_INFO = "Main_BD,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Main_BD,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=6,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Main_BD.hwdef" *) 
module Main_BD
   (USER_SMA,
    ...
    rs232_uart_rxd,
    rs232_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.USER_SMA CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.USER_SMA, CLK_DOMAIN Main_BD_clk_wiz_1_0_clk_out1, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output USER_SMA;
  ...
  assign USER_SMA = clk_wiz_1_clk_out2;
  ...
  Main_BD_axi_gpio_0_0 axi_gpio_0
  ...
  microblaze_0_local_memory_imp_1PS7GT microblaze_0_local_memory
...
module Main_BD_microblaze_0_axi_periph_0
  ...
  m00_couplers_imp_19TXFFX m00_couplers
  ...
  m01_couplers_imp_9L1KBY m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_9GCSTT s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_19TXFFX
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_9L1KBY
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_1PS7GT
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
...
module s00_couplers_imp_9GCSTT
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
