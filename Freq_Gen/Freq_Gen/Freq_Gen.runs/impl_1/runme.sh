...
HD_PWD='D:/Personal/FPGA/XilinxFPGA/Freq_Gen/Freq_Gen/Freq_Gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_BD_wrapper.tcl -notrace
