...
HD_PWD='D:/Personal/FPGA/XilinxFPGA/Freq_Gen/Freq_Gen/Freq_Gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_BD_wrapper.tcl
