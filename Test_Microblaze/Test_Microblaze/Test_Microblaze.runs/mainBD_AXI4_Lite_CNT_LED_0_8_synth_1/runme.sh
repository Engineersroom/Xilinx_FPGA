...
HD_PWD='D:/Personal/FPGA/XilinxFPGA/Test_Microblaze/Test_Microblaze/Test_Microblaze.runs/mainBD_AXI4_Lite_CNT_LED_0_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBD_AXI4_Lite_CNT_LED_0_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBD_AXI4_Lite_CNT_LED_0_8.tcl
