...
HD_PWD='D:/Personal/FPGA/XilinxFPGA/Test_Microblaze/Test_Microblaze/Test_Microblaze.runs/mainBD_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBD_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBD_dlmb_bram_if_cntlr_0.tcl
