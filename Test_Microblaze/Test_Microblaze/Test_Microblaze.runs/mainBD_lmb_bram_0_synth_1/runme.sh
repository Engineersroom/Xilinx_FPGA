...
HD_PWD='D:/Personal/FPGA/XilinxFPGA/Test_Microblaze/Test_Microblaze/Test_Microblaze.runs/mainBD_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBD_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBD_lmb_bram_0.tcl
